                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="pages_admin/navbar.html"><i class="ik ik-menu"></i><span>Navigation</span> <span class="badge badge-success">New</span></a>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Widgets</span> <span class="badge badge-danger">150+</span></a>
                                    <div class="submenu-content">
                                        <a href="pages_admin/widgets.html" class="menu-item">Basic</a>
                                        <a href="pages_admin/widget-statistic.html" class="menu-item">Statistic</a>
                                        <a href="pages_admin/widget-data.html" class="menu-item">Data</a>
                                        <a href="pages_admin/widget-chart.html" class="menu-item">Chart Widget</a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages_admin/ui/alerts.html" class="menu-item">Alerts</a>
                                        <a href="pages_admin/ui/badges.html" class="menu-item">Badges</a>
                                        <a href="pages_admin/ui/buttons.html" class="menu-item">Buttons</a>
                                        <a href="pages_admin/ui/navigation.html" class="menu-item">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="pages_admin/ui/modals.html" class="menu-item">Modals</a>
                                        <a href="pages_admin/ui/notifications.html" class="menu-item">Notifications</a>
                                        <a href="pages_admin/ui/carousel.html" class="menu-item">Slider</a>
                                        <a href="pages_admin/ui/range-slider.html" class="menu-item">Range Slider</a>
                                        <a href="pages_admin/ui/rating.html" class="menu-item">Rating</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-package"></i><span>Extra</span></a>
                                    <div class="submenu-content">
                                        <a href="pages_admin/ui/session-timeout.html" class="menu-item">Session Timeout</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages_admin/ui/icons.html"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                <div class="nav-lavel">Forms</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <div class="submenu-content">
                                        <a href="pages_admin/form-components.html" class="menu-item">Components</a>
                                        <a href="pages_admin/form-addon.html" class="menu-item">Add-On</a>
                                        <a href="pages_admin/form-advance.html" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages_admin/form-picker.html"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="pages_admin/table-bootstrap.html"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="pages_admin/table-datatable.html"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages_admin/charts-chartist.html" class="menu-item active">Chartist</a>
                                        <a href="pages_admin/charts-flot.html" class="menu-item">Flot</a>
                                        <a href="pages_admin/charts-knob.html" class="menu-item">Knob</a>
                                        <a href="pages_admin/charts-amcharts.html" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item">
                                    <a href="pages_admin/calendar.html"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="pages_admin/taskboard.html"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages_admin/login.php" class="menu-item">Login</a>
                                        <a href="pages_admin/register.html" class="menu-item">Register</a>
                                        <a href="pages_admin/forgot-password.html" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-file-text"></i><span>Other</span></a>
                                    <div class="submenu-content">
                                        <a href="pages_admin/profile.html" class="menu-item">Profile</a>
                                        <a href="pages_admin/invoice.html" class="menu-item">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages_admin/layouts.html"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
