        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item active">
                    <a href="/SE_Project/SE2/pages_user/index_user.php"><i class="ik ik-grid"></i><span>Home</span></a>
                </div>
                <div class="nav-item active">
                    <a href="/SE_Project/SE2/pages_user/equipment/select_equipment.php"><i class="ik ik-shopping-cart"></i><span>ระบบยืมอุปกรณ์</span></a>
                </div>
                <div class="nav-item active">
                    <a href="#"><i class="ik ik-clipboard"></i><span>คำขอทั้งหมด</span></a>
                </div>
                <div class="nav-item active">
                    <a href="/SE_Project/SE2/pages_user/history/history.php"><i class="ik ik-bar-chart-2"></i><span>ประวัติการยืม-คืนอุปกรณ์</span></a>
                </div>
