    ...
    <div class="login_form">
        <setion class="login-wrapper">
            ...
            <form name="userenter" onSubmit="return ChkValid()" method="post"  action="process.php">
                ...
                <input required="" name="form_account" type="text" autocapitalize="off" autocorrect="off">
                <label for="password">Password</label>
                <input class="password" required="" name="form_password" type="password">
